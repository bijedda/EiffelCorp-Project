...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements bank.BankServiceService {
    ...
    public bank.BankService getBankService() throws javax.xml.rpc.ServiceException {
    ...
    public bank.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bank.BankServiceSoapBindingStub _stub = new bank.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bank.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                bank.BankServiceSoapBindingStub _stub = new bank.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bank", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bank", "BankService"));
        }
