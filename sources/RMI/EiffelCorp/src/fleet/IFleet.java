...
public interface IFleet extends Remote {
	...
	public void add(String registrationNb, String model, String make, double topSpeed, String fuelType, int nbDoors) throws RemoteException, IOException, ClassNotFoundException;
	public void delete(String registrationNb) throws RemoteException, ClassNotFoundException, IOException;
	public List<IVehicle> getListVehicles()  throws RemoteException, FileNotFoundException, IOException, ClassNotFoundException ; 
