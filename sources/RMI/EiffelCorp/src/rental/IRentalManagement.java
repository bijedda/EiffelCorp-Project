...
public interface IRentalManagement extends Remote {
	...
	public boolean rentCar(IFleet fleet, int rentalID, String vehiculeRgNb, int customerNb, double costPerDay, Date dateDebut, IEmployee employee) throws RemoteException, IOException, ClassNotFoundException;
	...
	public List<IVehicle> getVehiclesRentedOnce(IFleet fleet) throws RemoteException, IOException, ClassNotFoundException;
